...
updaterenderList=()=>
{
    firebase.firestore().collection('users').doc(toString(this.currentUserDocumentId)).update(
        {
                ...
                <div className="viewListUser">
                    <div className="profileviewleftside">
                        ...
                        <div style = {{marginLeft : '-40px', marginTop : '6px'}}>
                            <h4>{this.currentUserName}</h4> 
                        </div>
                        <button style = {{marginTop : '-42px'}} className="Logout" onClick={this.logout}>Logout</button>
                    </div>
